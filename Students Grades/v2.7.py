...
def open_admin_window():
    ...
    tree = create_treeview(admin_window)
    ...
    set_path_button = tk.Button(admin_window, text="Set Allowed Path", command=lambda: set_allowed_path(tree, email_set))
...
def show_treeview_window(user_type, allowed_path):
    ...
    tree = create_treeview(treeview_window)
    tree.pack(expand=True, fill="both")
...
def login(login_window, email_var, password_var, user_type_var):
    ...
    if authenticate(email, password, user_type):
        ...
        show_treeview_window(user_type, users[email]['allowed_path'])
    else:
...
def main():
    ...
    admin_button = tk.Button(root, text="Admin: Set Allowed Path", command=open_admin_window)
